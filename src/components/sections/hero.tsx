...
const floatingElements = [
  ...
  { icon: Network, delay: 0.5, x: "80%", y: "30%" },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6">
            <span className="gradient-text">Unleashing the Future</span>
            <br />
            <span className="text-foreground">of Telecom</span>
          </h1>
          ...
          >
            Transform your communication infrastructure with cutting-edge 
            <span className="text-accent font-semibold"> Wireless & Wireline Network Solutions</span>. 
            From design to optimization, we deliver excellence at every step.
          </motion.p>
